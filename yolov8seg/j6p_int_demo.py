...
onnx_model = load_model("yolov8n_seg_output_s600/yolov8n_seg_640x640_nv12_ptq_model.onnx")
...
remove_op_by_ioname(func=func, io_name="output1")
remove_op_by_ioname(func=func, io_name="371")
remove_op_by_ioname(func=func, io_name="379")
remove_op_by_ioname(func=func, io_name="395")
remove_op_by_ioname(func=func, io_name="403")
remove_op_by_ioname(func=func, io_name="419")

compile(hb_quantized_model,"./yolov8n_seg_640x640_nv12.hbm", "nash-p")
