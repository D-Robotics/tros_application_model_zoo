## Single-image inference using modified_model_output/yolov8n_640x640_nv12_original_float_model.onnx
import sys
...
def main():
    ...
    sess = HB_ONNXRuntime(model_file="./yolov10n_output/yolov10n_640x640_nv12_original_float_model.onnx")
    ...
    postprocess2(outputs, origin_image, confidence=0.4, iou=0.4, save_path="./yolov10n_original_float_model.jpg")
