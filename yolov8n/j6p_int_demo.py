...
onnx_model = load_model("yolov8n_output_s600/yolov8n_640x640_nv12_ptq_model.onnx")
...
remove_op_by_ioname(func=func, io_name="318")
remove_op_by_ioname(func=func, io_name="334")
remove_op_by_ioname(func=func, io_name="350")

compile(hb_quantized_model,"./yolov8n_640x640_nv12.hbm", "nash-p")
