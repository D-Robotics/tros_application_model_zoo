...
# sess = HBRuntime("./model_output_s100/hand_224_224_optimized_float_model.onnx")
# sess = HBRuntime("./model_output_s100/hand_224_224_calibrated_model.onnx")
# sess = HBRuntime("./model_output_s100/hand_224_224_ptq_model.onnx")
sess = HBRuntime("./model_output_s100/hand_224_224_quantized_model.bc")
# sess = HBRuntime("./model_output_s100/hand_224_224.hbm")
...
if suffix == '.hbm' or suffix == '.bc':
    ...
    output = sess.run(output_names, {input_names[0]: y_plane[np.newaxis, ..., np.newaxis], input_names[1]: uv_plane[np.newaxis, ...]})
else:
