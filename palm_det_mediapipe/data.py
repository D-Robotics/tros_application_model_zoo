...
def data_transformer():
    transformers = [
        ...
        ResizeTransformer(target_size=(192, 192)),
...
def convert_image(src_image, dst_dir, transformers):
    ...
    # 以二进制形式存储标定样本到数据文件
    # breakpoint()
    save_path = os.path.join('kps/quantize/plam_det_S100', dst_dir, Path(src_image).stem + '.npy')
...
if __name__ == '__main__':
    ...
    current_dir = 'kps/quantize/plam_det_S100/test_images'
